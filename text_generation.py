...
def generate_samples(model, tokenizer, device, prefix = None, size=1,):
    """
...
def evaluate_samples(model, tokenizer, samples, device):
    """
...
if __name__ == '__main__':
    ...
    evaluated_texts = generate_dataset(model, tokenizer, bert_model, bert_tokenizer, size=1000)
    torch.cuda.empty_cache()
